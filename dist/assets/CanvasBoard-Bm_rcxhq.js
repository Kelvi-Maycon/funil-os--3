	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			node.data.metrics && node.data.metrics.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: cn("flex flex-wrap items-center gap-4 mt-2 pt-3 border-t", isTraffic && !customColor ? "border-white/10" : "border-[#E8E2D9]"),
				children: node.data.metrics.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col gap-0.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("text-[10px] font-bold uppercase tracking-wider", isTraffic && !customColor ? "text-white/50" : "text-[#8C7B6C]"),
						children: m.label
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("text-[13px] font-bold", isTraffic && !customColor ? "text-white" : "text-[#3D2B1F]"),
						children: m.value
					})]
				}, i))
			}),
...
function NodeSettingsModal({ node, isOpen, onClose, onSave }) {
	...
	const [status, setStatus] = (0, import_react.useState)("Rascunho");
	...
	const updateMetric = (i, k, v) => setMetrics(metrics.map((m, idx) => idx === i ? {
		...m,
		[k]: v
	} : m));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			className: "sm:max-w-[600px] max-h-[85vh] overflow-y-auto p-6 flex flex-col gap-6",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
						...
						className: cn("pointer-events-none", status === "Ativo" ? "bg-green-500" : status === "Rascunho" ? "bg-slate-400" : status === "Pausado" ? "bg-amber-500" : "bg-blue-500"),
						children: status
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
							className: "grid w-full grid-cols-5 bg-slate-100 rounded-xl p-1 mb-6",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsTrigger, {
									value: "geral",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}, i)), metrics.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-slate-500 text-center py-4",
									children: "Nenhuma métrica configurada."
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								onClick: addMetric,
								variant: "outline",
								className: "w-full rounded-xl border-dashed h-10 gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { size: 16 }), " Adicionar Métrica"]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
							value: "tarefas",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
												...
												className: cn("h-8 rounded-lg bg-white font-medium text-sm", t.status === "Concluído" && "line-through text-slate-400")
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												variant: "ghost",
												size: "icon",
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
												className: "h-8 rounded-lg text-xs w-[120px] bg-white",
								...
								}, t.id)), nodeTasks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-slate-500 text-center py-4",
								...
								variant: "outline",
								className: "w-full rounded-xl border-dashed h-10 gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { size: 16 }), " Nova Tarefa"]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
							value: "recursos",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
										className: "text-sm font-semibold text-slate-700",
										children: "Cor de Destaque"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex flex-wrap gap-3",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											onClick: () => setColor(""),
											className: cn("w-8 h-8 rounded-full border-2 border-slate-200 flex items-center justify-center bg-slate-50 hover:bg-slate-100 transition-all", !color && "ring-2 ring-slate-400 ring-offset-2"),
											...
											className: cn("w-8 h-8 rounded-full border border-black/10 hover:scale-110 transition-all shadow-sm", color === c && "ring-2 ring-offset-2 ring-slate-400 scale-110")
										}, c))]
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex flex-row items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "space-y-1",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
											...
											children: "Habilitar checklist direto no canvas."
										})]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
										checked: isTaskMode,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
											...
											className: "text-xs text-slate-500 font-medium",
											children: "Aplica efeito visual de finalizado."
										})]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
										checked: isCompleted,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
					className: "mt-2 sm:justify-end gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						variant: "ghost",
						onClick: onClose,
...
//# sourceMappingURL=CanvasBoard-Bm_rcxhq.js.map