import { a as AvatarImage, i as AvatarFallback, n as TasksBoard, o as Paperclip, r as Avatar, t as TaskDetailSheet } from "./TaskDetailSheet-5OgkRmvy.js";
import { d as Clock, l as toDate, t as format } from "./format-DEsdjysw.js";
import { a as TableHeader, i as TableHead, n as TableBody, o as TableRow, r as TableCell, s as LayoutGrid, t as Table } from "./table-CfbYntL_.js";
import { t as List } from "./list-Cyp9sHvU.js";
import { i as TabsTrigger, n as TabsContent, o as MessageSquare, r as TabsList, t as Tabs } from "./tabs-Bb90fePO.js";
import { i as Plus } from "./dist-Dp-XKn9u.js";
import { Bt as useNavigate, Gt as __export, Kt as __toESM, Nt as require_jsx_runtime, Ut as require_react, Wt as __commonJSMin, _ as Button, b as useTaskStore_default, bt as clsx_default, f as useQuickActionStore_default, ht as CircleAlert, lt as Network, rt as cn, vt as createLucideIcon } from "./index-CNJOID4m.js";
import { t as Badge } from "./badge-tsvDnjsC.js";
import { t as isToday } from "./isToday-CShDA4ew.js";
import { i as CardTitle, n as CardContent, r as CardHeader, t as Card } from "./card-C9KLSGH5.js";
...
function isPast(date$1) {
	return +toDate(date$1) < Date.now();
}
...
var require__baseIsNative = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var isFunction$17 = require_isFunction(), isMasked = require__isMasked(), isObject$9 = require_isObject(), toSource$1 = require__toSource();
	var reRegExpChar = /[\\^$.*+?()[\]{}|]/g;
	...
	function baseIsNative$1(value) {
		...
		return (isFunction$17(value) ? reIsNative : reIsHostCtor).test(toSource$1(value));
	}
...
var adaptEventsOfChild = function adaptEventsOfChild$1(props, data, index) {
	if (!(0, import_isObject$3.default)(props) || _typeof$42(props) !== "object") return null;
	var out = null;
...
var _excluded$15 = ["children"], _excluded2$4 = ["children"];
...
var isValidSpreadableProp = function isValidSpreadableProp$1(property$2, key, includeEvents, svgElementType) {
	...
	return key.startsWith("data-") || !(0, import_isFunction$15.default)(property$2) && (svgElementType && matchingElementTypeKeys.includes(key) || SVGElementPropKeys.includes(key)) || includeEvents && EventKeys.includes(key);
};
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					var className = clsx_default(_defineProperty$37(_defineProperty$37({ "recharts-legend-item": true }, "legend-item-".concat(i), true), "inactive", entry.inactive));
					if (entry.type === "none") return null;
					var entryValue = !(0, import_isFunction$14.default)(entry.value) ? entry.value : null;
					warn(!(0, import_isFunction$14.default)(entry.value), "The name property is also required when using a function for the dataKey of a chart's cartesian components. Ex: <Bar name=\"Name of my Data\"/>");
...
var require_isArrayLike = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var isFunction$14 = require_isFunction(), isLength$1 = require_isLength();
	function isArrayLike$5(value) {
		return value != null && isLength$1(value.length) && !isFunction$14(value);
	}
...
function getUniqPayload(payload, option, defaultUniqBy$2) {
	...
	if ((0, import_isFunction$13.default)(option)) return (0, import_uniqBy.default)(payload, option);
	return payload;
}
...
function formatDecimalParts(x$1, p) {
	if (!isFinite(x$1) || x$1 === 0) return null;
	var i = (x$1 = p ? x$1.toExponential(p - 1) : x$1.toExponential()).indexOf("e"), coefficient = x$1.slice(0, i);
...
function formatPrefixAuto_default(x$1, p) {
	...
	if (!d) return prefixExponent = void 0, x$1.toPrecision(p);
...
function locale_default(locale$2) {
	...
	function newFormat(specifier, options) {
		...
		var prefix$2 = (options && options.prefix !== void 0 ? options.prefix : "") + (symbol === "$" ? currencyPrefix : symbol === "#" && /[boxX]/.test(type) ? "0" + type.toLowerCase() : ""), suffix = (symbol === "$" ? currencySuffix : /[%p]/.test(type) ? percent : "") + (options && options.suffix !== void 0 ? options.suffix : "");
		...
		function format$2(value) {
			...
			if (type === "c") {
				...
				valueSuffix = (type === "s" && !isNaN(value) && prefixExponent !== void 0 ? prefixes[8 + prefixExponent / 3] : "") + valueSuffix + (valueNegative && sign$1 === "(" ? ")" : "");
				if (maybeSuffix) {
					i = -1, n = value.length;
...
function formatLocale(locale$2) {
	...
	function newFormat(specifier, formats$1) {
		return function(date$1) {
			var string = [], i = -1, j = 0, n = specifier.length, c$1, pad$1, format$2;
			...
			while (++i < n) if (specifier.charCodeAt(i) === 37) {
				...
				if (format$2 = formats$1[c$1]) c$1 = format$2(date$1, pad$1);
				string.push(c$1);
				j = i + 1;
			}
			string.push(specifier.slice(j, i));
...
function getValueByDataKey(obj, dataKey, defaultValue) {
	...
	if ((0, import_isFunction$12.default)(dataKey)) return dataKey(obj);
	return defaultValue;
}
...
var parseScale = function parseScale$1(axis, chartType, hasBar) {
	...
	return (0, import_isFunction$12.default)(scale) ? { scale } : {
		scale: point(),
		realScaleType: "point"
	};
};
...
var parseSpecifiedDomain = function parseSpecifiedDomain$1(specifiedDomain, dataDomain, allowDataOverflow) {
	if ((0, import_isFunction$12.default)(specifiedDomain)) return specifiedDomain(dataDomain, allowDataOverflow);
	...
	} else if ((0, import_isFunction$12.default)(specifiedDomain[0])) domain[0] = specifiedDomain[0](dataDomain[0]);
	...
	} else if ((0, import_isFunction$12.default)(specifiedDomain[1])) domain[1] = specifiedDomain[1](dataDomain[1]);
...
var getLabel = function getLabel$1(props) {
	...
	if ((0, import_isFunction$10.default)(formatter)) return formatter(label);
	return label;
};
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel$1(props) {
	...
	if ((0, import_isObject$1.default)(position) && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$22({
...
function Label(_ref4) {
	...
	if (!viewBox || (0, import_isNil$3.default)(value) && (0, import_isNil$3.default)(children) && !/* @__PURE__ */ (0, import_react.isValidElement)(content) && !(0, import_isFunction$10.default)(content)) return null;
	if (/* @__PURE__ */ (0, import_react.isValidElement)(content)) return /* @__PURE__ */ (0, import_react.cloneElement)(content, props);
	var label;
	if ((0, import_isFunction$10.default)(content)) {
	...
	return /* @__PURE__ */ import_react.createElement(Text, _extends$17({ className: clsx_default("recharts-label", className) }, attrs, positionAttrs, { breakAll: textBreakAll }), label);
}
...
var parseLabel = function parseLabel$1(label, viewBox) {
	...
	if ((0, import_isFunction$10.default)(label)) return /* @__PURE__ */ import_react.createElement(Label, {
		key: "label-implicit",
		content: label,
		viewBox
	});
	if ((0, import_isObject$1.default)(label)) return /* @__PURE__ */ import_react.createElement(Label, _extends$17({ viewBox }, label, { key: "label-implicit" }));
	return null;
};
...
var _excluded$7 = ["valueAccessor"], _excluded2$2 = [
	"data",
	"dataKey",
	"clockWise",
	"id",
...
function LabelList(_ref) {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map(function(entry, index) {
		...
		return /* @__PURE__ */ import_react.createElement(Label, _extends$16({}, filterProps(entry, true), others, idProps, {
			...
			value,
			textBreakAll,
			viewBox: Label.parseViewBox((0, import_isNil$2.default)(clockWise) ? entry : _objectSpread$21(_objectSpread$21({}, entry), {}, { clockWise })),
			key: "label-".concat(index),
			index
		}));
	}));
...
function parseLabelList(label, data) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(label) || (0, import_isFunction$9.default)(label)) return /* @__PURE__ */ import_react.createElement(LabelList, {
		key: "labelList-implicit",
		data,
		content: label
	});
...
var getCurveFactory = function getCurveFactory$1(type, layout) {
	if ((0, import_isFunction$8.default)(type)) return type;
...
var isDev = true;
var warn$1 = function warn$2(condition, format$2, a$1, b, c$1, d, e, f) {
		...
		},
		{
			...
			value: function render() {
				...
				var cloneContainer = function cloneContainer$1(container) {
					...
					return /* @__PURE__ */ (0, import_react.cloneElement)(container, _objectSpread$16(_objectSpread$16({}, others), {}, {
...
var Cross = function Cross$1(_ref) {
	var _ref$x = _ref.x, x$1 = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y$1 = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$5(_ref, _excluded$5);
...
function Shape(_ref2) {
	...
	else if ((0, import_isFunction$7.default)(option)) shape = option(props);
	...
	return _createClass$10(Brush$1, [
		...
		},
		{
			...
			value: function getTextOfTick(index) {
				...
				return (0, import_isFunction$6.default)(tickFormatter) ? tickFormatter(text, index) : text;
			}
		},
		{
		...
		},
		{
			...
			value: function renderTraveller(option, props) {
				...
				else if ((0, import_isFunction$6.default)(option)) rectangle = option(props);
...
function typeguardBarRectangleProps(_ref, props) {
	...
	return _objectSpread$9(_objectSpread$9(_objectSpread$9(_objectSpread$9(_objectSpread$9({}, props), option), x$1 ? { x: x$1 } : {}), y$1 ? { y: y$1 } : {}), {}, {
		height,
		width,
		name: props.name,
		radius: props.radius
...
var formatAxisMap = function formatAxisMap$1(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		var ticks$1 = getTicksOfScale(scale, _objectSpread$7(_objectSpread$7({}, axis), {}, { realScaleType }));
		if (axisType === "xAxis") {
		...
		var finalAxis = _objectSpread$7(_objectSpread$7(_objectSpread$7({}, axis), ticks$1), {}, {
			realScaleType,
			x: x$1,
			y: y$1,
			scale,
...
var renderLine = function renderLine$1(option, props) {
	...
	else if ((0, import_isFunction$5.default)(option)) line = option(props);
...
_defineProperty$8(ReferenceDot, "renderDot", function(option, props) {
	...
	else if ((0, import_isFunction$4.default)(option)) dot = option(props);
...
var ReferenceArea = /* @__PURE__ */ function(_React$Component) {
	...
	return _createClass$5(ReferenceArea$1, [{
		...
		value: function render() {
			...
			return /* @__PURE__ */ import_react.createElement(Layer, { className: clsx_default("recharts-reference-area", className) }, ReferenceArea$1.renderRect(shape, _objectSpread$4(_objectSpread$4({ clipPath }, filterProps(this.props, true)), rect)), Label.renderCallByParent(this.props, rect));
		}
	}]);
}(import_react.Component);
...
_defineProperty$7(ReferenceArea, "renderRect", function(option, props) {
	...
	else if ((0, import_isFunction$3.default)(option)) rect = option(props);
...
function getTicksEnd(sign$1, boundaries, getTickSize, ticks$1, minTickGap) {
	...
	var _loop = function _loop$1(i$1) {
		...
		if (i$1 === len - 1) {
			...
			result[i$1] = entry = _objectSpread$3(_objectSpread$3({}, entry), {}, { tickCoord: gap > 0 ? entry.coordinate - gap * sign$1 : entry.coordinate });
		} else result[i$1] = entry = _objectSpread$3(_objectSpread$3({}, entry), {}, { tickCoord: entry.coordinate });
		if (isVisible(sign$1, entry.tickCoord, getSize, start, end)) {
			end = entry.tickCoord - sign$1 * (getSize() / 2 + minTickGap);
			result[i$1] = _objectSpread$3(_objectSpread$3({}, entry), {}, { isShow: true });
		}
	};
...
function getTicksStart(sign$1, boundaries, getTickSize, ticks$1, minTickGap, preserveEnd) {
	...
	if (preserveEnd) {
		...
		result[len - 1] = tail = _objectSpread$3(_objectSpread$3({}, tail), {}, { tickCoord: tailGap > 0 ? tail.coordinate - tailGap * sign$1 : tail.coordinate });
...
function getTicks(props, fontSize, letterSpacing) {
	...
	var getTickSize = function getTickSize$1(content, index) {
		var value = (0, import_isFunction$2.default)(tickFormatter) ? tickFormatter(content.value, index) : content.value;
	...
	return _createClass$4(CartesianAxis$1, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				return /* @__PURE__ */ import_react.createElement("line", _extends$3({}, props, { className: clsx_default("recharts-cartesian-axis-line", (0, import_get$1.default)(axisLine, "className")) }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks(ticks$1, fontSize, letterSpacing) {
				...
				var finalTicks = getTicks(_objectSpread$2(_objectSpread$2({}, this.props), {}, { ticks: ticks$1 }), fontSize, letterSpacing);
		...
		},
		{
			...
			value: function render() {
				...
				var _this$props8 = this.props, ticks$1 = _this$props8.ticks, noTicksProps = _objectWithoutProperties$1(_this$props8, _excluded3);
				var finalTicks = ticks$1;
				if ((0, import_isFunction$1.default)(ticksGenerator)) finalTicks = ticks$1 && ticks$1.length > 0 ? ticksGenerator(this.props) : ticksGenerator(noTicksProps);
		...
		value: function renderTickItem(option, props, value) {
			...
			else if ((0, import_isFunction$1.default)(option)) tickItem = option(_objectSpread$2(_objectSpread$2({}, props), {}, { className: combinedClassName }));
...
var BarChart = function generateCategoricalChart$1(_ref6) {
	var chartName = _ref6.chartName, GraphicalChild = _ref6.GraphicalChild, _ref6$defaultTooltipE = _ref6.defaultTooltipEventType, defaultTooltipEventType = _ref6$defaultTooltipE === void 0 ? "axis" : _ref6$defaultTooltipE, _ref6$validateTooltip = _ref6.validateTooltipEventTypes, validateTooltipEventTypes = _ref6$validateTooltip === void 0 ? ["axis"] : _ref6$validateTooltip, axisComponents = _ref6.axisComponents, legendContent = _ref6.legendContent, formatAxisMap$1 = _ref6.formatAxisMap, defaultProps$3 = _ref6.defaultProps;
...
function TasksOverview({ tasks }) {
	...
	const overdue = tasks.filter((t) => t.status !== "Concluído" && isPast(new Date(t.deadline)) && !isToday(new Date(t.deadline))).length;
	const priorityCount = tasks.reduce((acc, t) => {
		acc[t.priority] = (acc[t.priority] || 0) + 1;
		return acc;
	}, {});
	const priorityData = Object.keys(priorityCount).map((k$1) => ({
		name: k$1,
		total: priorityCount[k$1]
	}));
	const upcomingTasks = tasks.filter((t) => t.status !== "Concluído").sort((a$1, b) => new Date(a$1.deadline).getTime() - new Date(b.deadline).getTime()).slice(0, 5);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-6",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						...
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListTodo, { className: "h-5 w-5 text-muted-foreground" })]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					className: "bg-warning-bg border-none shadow-sm",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						className: "flex flex-row items-center justify-between pb-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
							className: "text-sm font-medium text-warning-foreground",
							children: "In Progress"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "h-5 w-5 text-warning" })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					className: "bg-success-bg border-none shadow-sm",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						className: "flex flex-row items-center justify-between pb-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
						...
						className: "text-4xl font-bold text-success-foreground",
						children: completed
					}) })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					className: "bg-danger-bg border-none shadow-sm",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						className: "flex flex-row items-center justify-between pb-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
							className: "text-sm font-medium text-danger-foreground",
							children: "Overdue"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-5 w-5 text-danger" })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "text-4xl font-bold text-danger-foreground",
						children: overdue
					}) })]
				})
			]
			...
			children: [
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, {
											...
											children: priorityData.map((entry, index) => {
												return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cell, { fill: entry.name === "Alta" ? "#EF4444" : entry.name === "Média" ? "#3B82F6" : "#D1D5DB" }, `cell-${index}`);
											})
										})
									]
								})
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
						...
						className: "space-y-5",
						children: [upcomingTasks.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: format(new Date(t.deadline), "MMM dd, yyyy")
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								variant: "outline",
								className: t.priority === "Alta" ? "bg-danger-bg text-danger-foreground border-none px-3" : t.priority === "Média" ? "bg-info-bg text-info-foreground border-none px-3" : "bg-muted text-muted-foreground border-none px-3",
								children: t.priority
							})]
						}, t.id)), upcomingTasks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					className: "col-span-1 md:col-span-2 lg:col-span-1 flex flex-col",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
						className: "text-xl flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, { className: "w-5 h-5 text-muted-foreground" }), "Recent Updates"]
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
						className: "flex-1",
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarImage, { src: activity.avatar }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarFallback, { children: activity.user[0] })]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "absolute -bottom-1 -right-1 bg-background rounded-full p-0.5 shadow-sm",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: `w-4 h-4 ${activity.iconColor}` })
										})]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "font-semibold text-foreground",
													children: activity.task
												}),
												activity.target && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
													" ",
													"to",
													" ",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
						...
						children: t.projectId === "p1" ? "Backend API" : t.projectId === "p2" ? "Marketing" : "NovaBoard App"
					}) }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
						variant: "outline",
						className: pc.color,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
						className: "text-muted-foreground",
						children: t.deadline ? format(new Date(t.deadline), "MMM dd, yyyy") : "-"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
...
function Tasks() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 md:px-8 border-b border-border -mx-6 -mt-6 md:-mx-8 md:-mt-8 mb-8 min-h-[80px] shrink-0",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [tasks.length, " Tarefas no total"]
						})
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
					className: "bg-card gap-2 p-1.5 rounded-full flex flex-wrap shrink-0 justify-start border border-border inline-flex h-auto w-fit mb-6",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutList, { className: "w-4 h-4 mr-2" }), " Overview"]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
							value: "board",
							className: "rounded-full px-5 py-2 data-[state=active]:bg-secondary data-[state=active]:text-primary text-muted-foreground hover:text-foreground font-medium transition-all text-md",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutGrid, { className: "w-4 h-4 mr-2" }), " Quadro"]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
							value: "list",
							className: "rounded-full px-5 py-2 data-[state=active]:bg-secondary data-[state=active]:text-primary text-muted-foreground hover:text-foreground font-medium transition-all text-md",
					...
					className: "flex-1 overflow-auto -mx-4 px-4 pb-8 no-scrollbar",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
							value: "overview",
							className: "mt-0 h-full border-none outline-none",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TasksOverview, { tasks })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
							value: "board",
							className: "mt-0 h-full border-none outline-none",
...
//# sourceMappingURL=Tasks-Qy3ZKmki.js.map