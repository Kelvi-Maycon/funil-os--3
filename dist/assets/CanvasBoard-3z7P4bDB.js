...
function NodeItem({ node, selected, isNodeDragging, snapToGrid, activeTool, taskProgress, onPointerDownAction, onMove, onMoveEnd, onResize, onResizeEnd, scale, onOpenRightPanel, onOpenSettings, onToggleComplete, onDelete, onAddChild, onTextChange, onEdgeDragStart, onDropResource }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("absolute top-0 left-0 pointer-events-auto w-[280px] rounded-[1.25rem] p-5 z-10 flex flex-col gap-3 group select-none duration-200", !currentlyDragging ? "transition-[box-shadow,background-color,border-color,opacity,transform]" : "transition-[box-shadow,background-color,border-color,opacity]", isTraffic && "bg-[#3D2B1F] border border-[#3D2B1F] shadow-lg", isFeatured && "bg-white border-2 border-[#C2714F] shadow-2xl", isStandard && "bg-white border border-[#E8E2D9] shadow-sm", isHovered && !selected && !isFeatured && "shadow-md", selected && "ring-4 ring-[#C2714F]/20 border-[#C2714F] shadow-xl", currentlyDragging && "opacity-95 z-50 shadow-2xl"),
		style: {
...
//# sourceMappingURL=CanvasBoard-3z7P4bDB.js.map