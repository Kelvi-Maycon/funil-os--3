import { t as format } from "./format-DEsdjysw.js";
import { t as Ellipsis } from "./ellipsis-BvouK6Ns.js";
import { a as Checkbox, o as MessageSquare } from "./tabs-Bb90fePO.js";
import { i as Plus } from "./dist-Dp-XKn9u.js";
import { t as Trash2 } from "./trash-2-DEmubwIs.js";
import { Bt as useNavigate, Et as useCallbackRef, Kt as __toESM, Nt as require_jsx_runtime, S as useProjectStore_default, Ut as require_react, Wt as __commonJSMin, _t as Check, a as SelectItem, d as generateId, i as SelectContent, j as Primitive, lt as Network, m as SheetContent, o as SelectTrigger, p as Sheet, r as Select, rt as cn, s as SelectValue, vt as createLucideIcon, wt as useLayoutEffect2 } from "./index-CNJOID4m.js";
import { t as Badge } from "./badge-tsvDnjsC.js";
import { n as CardContent, t as Card } from "./card-C9KLSGH5.js";
import { t as ptBR } from "./pt-BR-DWhhPtsv.js";
...
var priorityConfig = {
	...
	Alta: {
		label: "High",
		color: "bg-danger-bg text-danger border-transparent"
	}
};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: columnsConfig.map((col) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("w-80 shrink-0 flex flex-col rounded-2xl p-4 transition-all duration-200 relative border border-transparent", col.bg, isDragOver && "border-primary/30 shadow-sm bg-opacity-80"),
				onDragOver: (e) => {
					e.preventDefault();
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-xs font-semibold text-muted-foreground bg-white/60 rounded-full px-2 py-0.5",
					...
					children: [colTasks.map((t) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
							...
							className: cn("cursor-grab active:cursor-grabbing shadow-sm rounded-2xl bg-white relative overflow-hidden", draggingId === t.id ? "opacity-40 border-primary/40 border-dashed shadow-none ring-0" : "opacity-100 border-border hover:shadow-md hover:border-primary/40 transition-all"),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: cn("absolute left-0 top-0 bottom-0 w-1 rounded-l-2xl", t.priority === "Alta" && "bg-danger", t.priority === "Média" && "bg-warning", t.priority === "Baixa" && "bg-border") }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
								className: "p-4 flex flex-col gap-3 pl-5",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex justify-between items-center mt-3 pt-3 border-t border-border/50",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarImage, { src: t.avatar }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarFallback, {
													className: "text-[10px] bg-secondary text-primary",
													children: t.assignee?.[0] || "U"
												})]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "w-6 h-6 rounded-full border-2 border-white bg-white flex items-center justify-center text-muted-foreground border-dashed",
						...
						className: "h-32 rounded-2xl border-2 border-dashed border-primary/40 bg-primary/5 animate-fade-in transition-all flex items-center justify-center",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => handleUpdate({ status: localTask.status === "Concluído" ? "A Fazer" : "Concluído" }),
							className: cn("w-7 h-7 rounded-full border flex items-center justify-center transition-colors shrink-0", localTask.status === "Concluído" ? "bg-[#4CAF50] border-[#4CAF50] text-white" : "border-[#E8E2D9] text-transparent hover:border-[#C2714F] hover:text-[#C2714F]/50"),
...
//# sourceMappingURL=TaskDetailSheet-5OgkRmvy.js.map