import { d as Clock, t as format } from "./format-CiuzIP8n.js";
import { n as Image, t as useResourceStore_default } from "./useResourceStore-CRJTZuVH.js";
import { a as Checkbox, i as TabsTrigger, n as TabsContent, o as MessageSquare, r as TabsList, t as Tabs } from "./tabs-DUFgzUac.js";
import { i as Plus } from "./dist-PLdVY3Bp.js";
import { t as Trash2 } from "./trash-2-MgNMiJqU.js";
import { Bt as useNavigate, D as DialogFooter, Dt as Primitive, E as DialogDescription, Ft as useComposedRefs, Ht as useSearchParams, It as composeEventHandlers, J as TooltipContent, Kt as __toESM, Lt as useToast, Mt as createContextScope, Nt as require_jsx_runtime, O as DialogHeader, T as DialogContent, Ut as require_react, Y as TooltipTrigger, _ as Button, a as SelectItem, at as X, b as useTaskStore_default, c as usePrevious, d as generateId, i as SelectContent, it as Zap, k as DialogTitle, n as Textarea, o as SelectTrigger, ot as SquareCheckBig, pt as FileText, q as Tooltip, r as Select, rt as cn, s as SelectValue, t as Label, tt as useSize, ut as LayoutTemplate, vt as createLucideIcon, w as Dialog, x as useFunnelStore_default, xt as useControllableState, y as useDocumentStore_default } from "./index-C6ru2EwQ.js";
import { t as Badge } from "./badge-COYU19hD.js";
import { t as ConfirmDialog } from "./ConfirmDialog-Ctn7QQiJ.js";
...
function NodeItem({ node, selected, snapToGrid, activeTool, taskProgress, onPointerDownAction, onMove, onMoveEnd, onResize, onResizeEnd, scale, onOpenRightPanel, onOpenSettings, onToggleComplete, onDelete, onAddChild, onTextChange, onEdgeDragStart, onDropResource }) {
	...
	if ([
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: cn("absolute top-0 left-0 pointer-events-auto flex items-center justify-center z-10 group text-[#3D2B1F]", selected && "shadow-md", isDragging || isResizing ? "opacity-95 z-50 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] cursor-grabbing scale-[1.02]" : isPanMode ? "cursor-grab" : isSelectMode ? "cursor-pointer" : ""),
			style: {
				transform: `translate3d(${node.x}px, ${node.y}px, 0)`,
				width: w,
				height: h,
	...
	if (node.type === "Text") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("absolute top-0 left-0 pointer-events-auto min-w-[150px] max-w-[400px] p-4 bg-[#FAF7F2] rounded-xl shadow-sm border border-[#E8E2D9] text-[#3D2B1F] z-10 group", selected && "ring-2 ring-[#C2714F]/60 shadow-md", isDragging ? "opacity-95 scale-[1.02] z-50 cursor-grabbing shadow-xl ring-2 ring-[#C2714F]/50" : isPanMode ? "cursor-grab" : isSelectMode ? isEditingText ? "cursor-text" : "cursor-pointer" : ""),
		style: {
			transform: `translate3d(${node.x}px, ${node.y}px, 0)`,
			transition: isDragging ? "none" : "transform 0.15s cubic-bezier(0.2, 0, 0, 1)"
		},
	...
	if (node.type === "Image") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("absolute top-0 left-0 pointer-events-auto w-[300px] rounded-2xl shadow-sm border border-[#E8E2D9] bg-white z-10 overflow-hidden group", selected && "ring-4 ring-[#C2714F]/40 border-[#C2714F] shadow-md", isDragging ? "opacity-95 scale-[1.02] z-50 cursor-grabbing shadow-xl ring-4 ring-[#C2714F]/50" : isPanMode ? "cursor-grab" : isSelectMode ? "cursor-pointer" : ""),
		style: {
			transform: `translate3d(${node.x}px, ${node.y}px, 0)`,
			transition: isDragging ? "none" : "transform 0.15s cubic-bezier(0.2, 0, 0, 1)"
		},
	...
	circumference - (taskProgress.total > 0 ? taskProgress.completed / taskProgress.total : 0) * circumference;
	taskProgress.total > 0 || node.data.isTaskMode;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("absolute top-0 left-0 pointer-events-auto w-[280px] rounded-[1.25rem] p-5 z-10 flex flex-col gap-3 group select-none transition-all duration-200", isTraffic && "bg-[#3D2B1F] border border-[#3D2B1F] shadow-lg", isFeatured && "bg-white border-2 border-[#C2714F] shadow-2xl", isStandard && "bg-white border border-[#E8E2D9] shadow-sm", isHovered && !selected && !isFeatured && "shadow-md", selected && "ring-4 ring-[#C2714F]/20 border-[#C2714F] shadow-xl", isDragging && "opacity-95 scale-[1.03] z-50 shadow-2xl"),
		style: {
			transform: `translate3d(${node.x}px, ${node.y}px, 0)`,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [isTraffic ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "w-10 h-10 rounded-xl bg-[#C2714F] flex items-center justify-center text-white shrink-0 shadow-sm",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
						size: 20,
						strokeWidth: 2
					})
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "w-10 h-10 rounded-xl bg-[#FAF7F2] flex items-center justify-center text-[#C2714F] shrink-0 border border-[#E8E2D9]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
						size: 20,
						strokeWidth: 2
					})
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						className: cn("font-bold text-[15px] truncate leading-tight", isTraffic ? "text-white" : "text-[#3D2B1F]"),
						children: node.data.name
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("text-[12px] mt-0.5 truncate font-medium", isTraffic ? "text-white/70" : "text-[#8C7B6C]"),
						children: node.data.subtitle || node.type
					})]
				})]
			}),
			node.data.metrics && node.data.metrics.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: cn("flex flex-wrap items-center gap-4 mt-2 pt-3 border-t", isTraffic ? "border-white/10" : "border-[#E8E2D9]"),
				children: node.data.metrics.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col gap-0.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("text-[10px] font-bold uppercase tracking-wider", isTraffic ? "text-white/50" : "text-[#8C7B6C]"),
						children: m.label
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("text-[13px] font-bold", isTraffic ? "text-white" : "text-[#3D2B1F]"),
						children: m.value
					})]
				}, i))
			}),
			isFeatured && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-2 flex flex-col gap-1.5 pt-3 border-t border-[#E8E2D9]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex justify-between items-center text-[11px] font-bold",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[#8C7B6C] uppercase tracking-wider",
						children: "Retenção"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[#C2714F]",
						children: node.data.retention || "42%"
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "h-2 w-full bg-[#FAF7F2] rounded-full overflow-hidden border border-[#E8E2D9]/50",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			node.data.isTaskMode && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					linkedTasks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: cn("h-px w-full my-1 rounded-full", isTraffic ? "bg-white/10" : "bg-[#E8E2D9]") }),
					linkedTasks.map((task) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox, {
							...
							className: cn("mt-0.5 w-3.5 h-3.5 rounded-[4px] border", isTraffic ? "border-white/30 data-[state=checked]:bg-white data-[state=checked]:text-[#3D2B1F]" : "border-[#E8E2D9] data-[state=checked]:bg-[#C2714F] data-[state=checked]:border-[#C2714F]")
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: cn("text-[12px] leading-tight font-bold flex-1 transition-all break-words", task.status === "Concluído" ? isTraffic ? "text-white/40 line-through" : "text-[#8C7B6C] line-through" : isTraffic ? "text-white" : "text-[#3D2B1F]"),
							children: task.title
						})]
					}, task.id)),
					isAddingTask ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							...
							className: cn("flex-1 text-[12px] border rounded px-2 py-1 outline-none transition-all w-full font-bold", isTraffic ? "bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-white/50" : "bg-[#FAF7F2] border-[#E8E2D9] text-[#3D2B1F] placeholder:text-[#8C7B6C] focus:border-[#C2714F]")
						})
						...
						className: cn("flex items-center gap-1.5 mt-1 text-[12px] font-bold transition-colors w-full text-left py-0.5 rounded-sm interactive-icon", isTraffic ? "text-white/50 hover:text-white" : "text-[#8C7B6C] hover:text-[#C2714F]"),
...
function RightPanel({ node, funnel, defaultTab = "details", onChange, onClose }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "w-80 bg-white border-l border-[#E8E2D9] h-full flex flex-col shadow-2xl z-30 shrink-0 absolute right-0 top-0 bottom-0 rounded-l-2xl",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
						className: "mx-6 mt-6 grid grid-cols-4 bg-[#FAF7F2] p-1 rounded-xl border border-[#E8E2D9]",
						children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "bg-[#FAF7F2] p-3.5 rounded-xl border border-[#E8E2D9]",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-[10px] font-bold text-[#8C7B6C] uppercase tracking-wider",
										children: "Receita"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "text-lg font-black text-[#3D2B1F] mt-1 flex items-center justify-between",
										children: ["14k", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleArrowUp, {
											size: 16,
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: "text-lg font-black text-[#3D2B1F] mt-1 flex items-center justify-between",
										children: ["2.4%", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleArrowDown, {
											size: 16,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									className: "text-[11px] font-bold text-[#8C7B6C] uppercase tracking-widest block",
									children: "Subtítulo"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: "text-[11px] font-medium text-[#8C7B6C]",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
									className: "flex-1 bg-[#FAF7F2] border-[#E8E2D9] rounded-xl text-[#3D2B1F] font-bold",
...
var MemoizedNodeItem = (0, import_react.memo)(NodeItem, (prev, next) => {
	return prev.node === next.node && prev.selected === next.selected && prev.snapToGrid === next.snapToGrid && prev.activeTool === next.activeTool && prev.taskProgress.total === next.taskProgress.total && prev.taskProgress.completed === next.taskProgress.completed && prev.scale === next.scale;
});
function CanvasBoard({ funnel, onChange, hideHeader, onBack }) {
	...
	const getEffectiveNode = (0, import_react.useCallback)((n) => {
		if (!n) return void 0;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex-1 flex relative overflow-hidden bg-transparent",
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Map, { size: 18 })
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, {
						side: "right",
						children: "Minimap"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: boardRef,
				className: cn("flex-1 relative canvas-container overflow-hidden canvas-grid", isPanning ? "cursor-grabbing" : isSpacePressed || activeTool === "Pan" ? "cursor-grab" : activeTool !== "Select" ? "cursor-crosshair" : ""),
				style: {
...
//# sourceMappingURL=CanvasBoard-CgLAuy5T.js.map