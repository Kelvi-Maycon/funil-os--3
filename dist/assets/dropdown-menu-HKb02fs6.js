import { t as ChevronRight } from "./chevron-right-CuEieoWJ.js";
import { t as Circle } from "./circle-ytIk1e1y.js";
import { n as Root, r as createRovingFocusGroupScope, t as Item } from "./dist-CqEi8k1x.js";
import { $ as Root2$1, Dt as dispatchDiscreteCustomEvent, Et as Primitive, Ft as composeEventHandlers, G as useFocusGuards, Ht as require_react, K as FocusScope, Mt as require_jsx_runtime, Nt as composeRefs, Ot as createCollection, Pt as useComposedRefs, Q as Content, St as Portal, Tt as useCallbackRef, U as hideOthers, W as Combination_default, Wt as __toESM, X as Anchor, Z as Arrow, _t as Check, bt as useControllableState, et as createPopperScope, jt as createContextScope, kt as createSlot, l as useDirection, nt as useId, rt as cn, vt as createLucideIcon, wt as DismissableLayer, xt as Presence } from "./index-Czp_lz6e.js";
...
var DropdownMenuSubTrigger = import_react.forwardRef(({ className, inset, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SubTrigger2, {
	ref,
	className: cn("flex cursor-default select-none items-center gap-2 rounded-md px-2 py-2 text-sm font-medium outline-none focus:bg-muted data-[state=open]:bg-muted [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", inset && "pl-8", className),
	...props,
...
var DropdownMenuSubContent = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SubContent2, {
	ref,
	className: cn("z-50 min-w-[8rem] overflow-hidden rounded-xl border bg-popover p-1.5 text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-[--radix-dropdown-menu-content-transform-origin]", className),
	...props
}));
...
var DropdownMenuItem = import_react.forwardRef(({ className, inset, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item2, {
	ref,
	className: cn("relative flex cursor-default select-none items-center gap-2 rounded-md px-2 py-2 text-sm font-medium outline-none transition-colors focus:bg-muted focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", inset && "pl-8", className),
	...props
}));
DropdownMenuItem.displayName = Item2.displayName;
var DropdownMenuCheckboxItem = import_react.forwardRef(({ className, children, checked, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CheckboxItem2, {
	ref,
	className: cn("relative flex cursor-default select-none items-center rounded-md py-2 pl-8 pr-2 text-sm font-medium outline-none transition-colors focus:bg-muted focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className),
	checked,
	...props,
...
export { EllipsisVertical as a, DropdownMenuTrigger as i, DropdownMenuContent as n, DropdownMenuItem as r, DropdownMenu as t };

//# sourceMappingURL=dropdown-menu-HKb02fs6.js.map